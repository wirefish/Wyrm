...
function makePlural(s, count) {
  ...
  let words = s.split();
  let prep_index = words.findIndex(function (x) { return PREPOSITIONS.has(x); });
  let noun_index = (prep_index <= 0) ? words.length - 1 : prep_index - 1;
